...
then
    ...
    do
        ...
        samtools sort --threads $threads -o $outputFolder/$prefix"_sorted-k$aln.bam" \
        -T $outputFolder/$prefix"_sorted-k$aln" $outputFolder/$prefix"_aln.bam" 
